...
OUTPUT_PATH = Path("data/processed/prediction_target_3d.csv")
...
if len(data) < 5:
    raise SystemExit("No hay suficientes filas limpias para predecir target_3d.")
...
if predicted_price > last_price + 0.5:
    direction = "SUBE"
elif predicted_price < last_price - 0.5:
    direction = "BAJA"
else:
    direction = "LATERAL"
...
out = pd.DataFrame([{
    ...
    "predicted_target_3d": round(predicted_price, 4),
